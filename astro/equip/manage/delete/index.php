...
<!-- article -->
	<div>
		<form action="./confirm.php" method="GET" class="form-horizontal" role="form">
			<div class="form-group"><label for="id" class="col-sm-2 control-label">设备ID</label><div class="col-sm-10"><input type="number" min="1" step="1" name="id" class="form-control" id="id" required="required"/></div></div>
			<div class="form-group"><div class="col-sm-offset-2 col-sm-10"><button type="submit" class="btn btn-warning">删除设备</button></div></div>
		</form>
	</div>
