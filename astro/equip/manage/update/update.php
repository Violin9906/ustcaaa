...
<!-- article -->
	<div>
		<center><h3>数据更新成功！请勿刷新此页面！</h3></center>
	</div>
...
<?php	
	...
	$stmt=$connection->prepare("UPDATE equipment SET type=?,value1=?,value2=?,state=?,remarks=? WHERE id=?;");
	$stmt->bind_param("sssssi",$type,$value1,$value2,$state,$remarks,$id);
	$stmt->execute();
